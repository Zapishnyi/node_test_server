...
const userDelete_validator_1 = require("../validators/userDelete.validator");
...
router.delete("/keys/:id", auth_check_1.auth.tokenCheck(tokenTypeList_enum_1.TokenEnumList.access), (0, id_check_1.idCheck)(), user_check_1.userCheck.role(), (0, validate_1.validateQuery)(userDelete_validator_1.validUserDelete.keysDelete), user_controller_1.userController.deleteKeysByParams);
