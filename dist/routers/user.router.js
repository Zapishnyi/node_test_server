...
router.get("/", auth_check_1.auth.tokenCheck(tokenTypeList_enum_1.TokenEnumList.access), user_check_1.userCheck.role(), (0, validate_1.validateQuery)(pagination_validator_1.validPagination.searchQuery), user_controller_1.userController.findAll);
